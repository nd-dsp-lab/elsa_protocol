...
- KTSJ24 (PETS’24) is ommitted from the full test suite because their implementation is compatible only with OpenFHE v1.0.3 (see [dependency script](https://github.com/nd-dsp-lab/PSMT/blob/main/dependencies.sh)). For users who wish to test the KTSJ24's PSMT protocol, install OpenFHE v1.0.3 and execute the code under ```\ktsj24```.
